...
Mule.prototype.parse = function(data) {
	...
	for (var i = 0; i < carr.length; i++) {
		...
		if (this.opt('chdesc')) {
			...
			var CharText = $('<div>');
			CharText.append($('<div style="font-weight:700; font-size:1.1em; align-self:center"">').text(cl[0] + ' ' + c.Level + ' #' + NumberFormat(c.id, ',')), $('<div style="font-weight:700; font-size:1.1em; align-self:center">').text(NumberFormat(c.CurrentFame, ',') + ' Fame '));
			...
			'<div class="flex-container noFlexAutoWidth noFlexAutoAlign" style="color:#fff; flex-flow:column">' 
				+ '<div class="flex-container noFlexAutoAlign" style="justify-content:flex-start">' 
					+ '<div class="petItem" style="background-position: -' + window.items[24102][3] + 'px -' + window.items[24102][4] + 'px; border:solid 1px #000; margin-right:8px"></div>' 
					+ '<div class="flex-container noFlexAutoWidth pr5" style="flex-flow:column; flex-shrink:0; margin-right:8px">' 
						+ '<div style="font-weight:700; font-size:1.4em; align-self:flex-start">' 
							+ CurrXP + '</div>' 
						+ '<div style="font-weight:700; font-size:1.4em; align-self:flex-start">' 
							+ CurrF + '</div>' 
					+ '</div>' 
					+ '<div class="flex-container noFlexAutoAlign" style="flex-direction:column">' 
						+ '<div style="font-weight:700; font-size:1.4em; align-self:flex-end"> XP</div>' 
						+ '<div style="font-weight:700; font-size:1.4em; align-self:flex-end"> Fame</div>' 
					+ '</div>'
				+ '</div>' 
				+ (( c.Pet) ?
				'<div class="flex-container noFlexAutoAlign mr5" style="justify-content:flex-start">' 
					+ '<div class="petItem" style="background-position: -' + window.items[536][3] + 'px -' + window.items[536][4] + 'px; border:solid 1px #000; margin-right:8px"></div>' 
					...
					+ '<div class="flex-container noFlexAutoAlign" style="flex-direction:column">'
						+ '<div style="font-weight:700; font-size:1.15em; align-self:flex-end">' 
							+ PetAbility(0, 'power') + '</div>'
						+ ((PetAbility(1, 'points') > 0) ?
						'<div style="font-weight:700; font-size:1.15em; align-self:flex-end">' 
							+ PetAbility(1, 'power') + '</div>' : '')
						+ ((PetAbility(2, 'points') > 0) ?
						'<div style="font-weight:700; font-size:1.15em; align-self:flex-end">' 
							+ PetAbility(2, 'power') + '</div>' : '')
					+ '</div>'
				+ '</div>' : '' )
			+ '</div>');
